...
% an_ids = {'TFRmth_D1t1_f2t40_fourier'};%'TFRmth_S03t2_f2t30_fourier'};
% an_ids = {'TFRmth_S1t2_madS8t0_f80t120'};%'TFRmth_S1t2_noneS8t0_f80t120'};%
% Control analyses:
% an_ids = {'TFRmth_S1t2_madS8t0_f80t120_osr'};%'TFRw_S1t2_madS8t0_f2t40_osr'};
...
for s = 1:4
    ...
    tfr_fname = [sbj_dir SBJs{s} '_stim_preproc_osr.mat']; % This is [-3 10] to cover all possible times
    fprintf('Loading %s\n',tfr_fname);
