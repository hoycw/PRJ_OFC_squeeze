...
fig_dir   = [prj_dir 'results/bhv/LMM/' table_name out_thresh_str '/decision/'];
...
for f = 1:length(dec_vars)
    % Identify outliers
    out_idx_all.(dec_vars{f}) = abs(table_all.(dec_vars{f}))>outlier_thresh;
